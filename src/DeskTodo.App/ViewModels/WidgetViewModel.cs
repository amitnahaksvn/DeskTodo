...
public sealed partial class WidgetViewModel : ViewModelBase, IDisposable
{
    ...
    /// <summary>Raised from the Command Palette (Feature 96, Roadmap-39-100.md). Same "ViewModel shouldn't construct Views" reasoning as <see cref="SettingsRequested"/>.</summary>
    public event EventHandler? WebhooksRequested;

    [RelayCommand]
    private void OpenWebhooks() => WebhooksRequested?.Invoke(this, EventArgs.Empty);

    /// <summary>Raised from the Command Palette (Feature 100, Roadmap-39-100.md). Same "ViewModel shouldn't construct Views" reasoning as <see cref="SettingsRequested"/>.</summary>
    public event EventHandler? ApiExplorerRequested;
    ...
    /// <summary>Raised from the Command Palette (Features 89/90, Roadmap-39-100.md). Same "ViewModel shouldn't construct Views" reasoning as <see cref="SettingsRequested"/>.</summary>
    public event EventHandler? MassImportRequested;
