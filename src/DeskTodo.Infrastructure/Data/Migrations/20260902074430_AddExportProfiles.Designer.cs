...
namespace DeskTodo.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260902074430_AddExportProfiles")]
    partial class AddExportProfiles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeskTodo.Domain.Entities.BulkEditRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("BulkEditRules", (string)null);
                });
            ...
            modelBuilder.Entity("DeskTodo.Domain.Entities.Decision", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DeskTodo.Domain.Entities.Distraction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("Distractions", (string)null);
                });

            modelBuilder.Entity("DeskTodo.Domain.Entities.ExportProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DeskTodo.Domain.Entities.FocusContext", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("FocusContexts", (string)null);
                });
            ...
            modelBuilder.Entity("DeskTodo.Domain.Entities.JournalEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DeskTodo.Domain.Entities.MigrationRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DeskTodo.Domain.Entities.ProjectTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("MilestoneItems")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DeskTodo.Domain.Entities.RecurringProjectSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("GeneratedProjectIds")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("GeneratedProjectNamePattern")
                        .IsRequired()
                        .HasMaxLength(400)
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("RecurringProjectSchedules", (string)null);
                });
            ...
            modelBuilder.Entity("DeskTodo.Domain.Entities.TaskRelationship", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("SourceTaskId", "TargetTaskId", "RelationshipType")
                        .IsUnique();

                    b.ToTable("TaskRelationships", (string)null);
                });
            ...
            modelBuilder.Entity("DeskTodo.Domain.Entities.WebhookDeliveryLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DeskTodo.Domain.Entities.WebhookSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DeskTodo.Domain.Entities.Distraction", b =>
                {
                    b.HasOne("DeskTodo.Domain.Entities.FocusSession", "FocusSession")
                        .WithMany()
            ...
            modelBuilder.Entity("DeskTodo.Domain.Entities.RecurringProjectSchedule", b =>
                {
                    b.HasOne("DeskTodo.Domain.Entities.ProjectTemplate", "ProjectTemplate")
                        .WithMany()
            ...
            modelBuilder.Entity("DeskTodo.Domain.Entities.TaskItem", b =>
                {
                    ...
                    b.HasOne("DeskTodo.Domain.Entities.FocusContext", "Context")
                        .WithMany("Tasks")
            ...
            modelBuilder.Entity("DeskTodo.Domain.Entities.TaskRelationship", b =>
                {
                    b.HasOne("DeskTodo.Domain.Entities.TaskItem", "SourceTask")
                        .WithMany()
                        .HasForeignKey("SourceTaskId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DeskTodo.Domain.Entities.TaskItem", "TargetTask")
                        .WithMany()
            ...
            modelBuilder.Entity("DeskTodo.Domain.Entities.WebhookDeliveryLog", b =>
                {
                    b.HasOne("DeskTodo.Domain.Entities.WebhookSubscription", null)
                        .WithMany()
