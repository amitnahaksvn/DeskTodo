...
public class PlannerViewModelTests
{
    ...
    public PlannerViewModelTests()
    {
        ...
        _sut = new PlannerViewModel(week, year, agenda, timeline, kanban, matrix, goals, milestones);
    }
    ...
    public async Task LoadAsync_LoadsEveryTab()
    {
        ...
        // Agenda/Timeline/Kanban/Matrix/Goals/Milestones have nothing in this fixture, so
        // "loaded" just means LoadAsync didn't throw and left them in their
