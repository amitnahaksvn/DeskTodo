...
**Status:** planning only — nothing in this document has been implemented yet. See `IMPLEMENTATION.md`'s roadmap table for a one-line link to this file and its live status.
...
# Feature 42 — Task History / Audit Timeline
...
# Feature 46 — Trash / Recovery Center
